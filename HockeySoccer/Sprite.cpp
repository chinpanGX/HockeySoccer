...
void Sprite::Draw(LPDIRECT3DTEXTURE9 Texture, float dx, float dy, float Width, float Height)
{
...
//	描画 (引数：テクスチャ、X座標、Y座標、テクスチャX座標、テクスチャY座標、テクスチャの横幅、テクスチャの縦幅)
void Sprite::Draw(LPDIRECT3DTEXTURE9 Texture, float dx, float dy, float Width, float Height, float tx, float ty,float tw, float th)
{
	LPDIRECT3DDEVICE9 pDevice = GetD3DDevice();
	D3DCOLOR Color = D3DCOLOR_RGBA(255, 255, 255, 255);	
...
void Sprite::Draw(LPDIRECT3DTEXTURE9 Texture, float dx, float dy, float Width, float Height, float tx, float ty, float tw, float th, float cx, float cy, float sx, float sy, float rotation)
{
	LPDIRECT3DDEVICE9 pDevice = GetD3DDevice();
	D3DCOLOR Color = D3DCOLOR_RGBA(255, 255, 255, 255);	
