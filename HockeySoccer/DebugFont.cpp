...
// グローバル変数
LPD3DXFONT			DebugFont::g_pD3DXFont = NULL;			// フォントへのポインタ
char				DebugFont::g_aStrDebug[1024] = {"\0"};	// デバッグ情報
LPDIRECT3DDEVICE9	DebugFont::pDevice;

// デバッグ表示処理の初期化
HRESULT DebugFont::Init(void)
{
